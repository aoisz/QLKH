...
public class QLKhoaHoc extends JFrame implements MouseListener {
    ...
    public void init() {
        ...
        ImageIcon logo = new ImageIcon(imgPath + "title.png");
...
//                System.out.println("KẾT QUẢ");
    ...
    public void outNav() {
        ...
        //Xuất ra Naigation
        nav.removeAll();
        ImageIcon img = new ImageIcon(imgPath + "course_170px.png");
        JLabel profile = new JLabel(img);
        
//        JLabel profile = new JLabel(new ImageIcon("D:/Workspace/Java/QLKH/src/main/java/img/course_170px.png"));
