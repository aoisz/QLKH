...
public class OnsiteCourseGUI extends JPanel {
    ...
    int courseID;
    Object obTime;
    private String imgPath = System.getProperty("user.dir") + "\\src\\main\\java\\img\\";
...
//                tbStudent.setEnabled(false);
    ...
    public JPanel pnOption() {
        ...
        lbAdd = new JLabel(new ImageIcon(imgPath + "add.png"), JLabel.CENTER);
        lbEdit = new JLabel(new ImageIcon(imgPath + "edit.png"), JLabel.CENTER);
        lbRemove = new JLabel(new ImageIcon(imgPath + "remove.png"), JLabel.CENTER);
        ...
        btnConfirm = new JLabel(new ImageIcon(imgPath + "done.png"));
        btnConfirm.setVisible(false);
        btnConfirm.setBounds(80, 50, 155, 100);
        btnConfirm.setCursor(new Cursor(Cursor.HAND_CURSOR));

        btnBack = new JLabel(new ImageIcon(imgPath + "back.png"));
        btnBack.setVisible(false);
    ...
    public JPanel pnFind() {
        ...
        // Custem Icon search
        JLabel searchIcon = new JLabel(new ImageIcon(imgPath + "search_24px.png"));
        ...
        txtSearch.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                searchIcon.setIcon(new ImageIcon(imgPath + "search_24px.png")); //Đổi màu icon
                pnFind.setBorder(createLineBorder(new Color(52, 152, 219))); // Đổi màu viền 
            }

            public void focusLost(FocusEvent e) //Trờ về như cũ
            {
                searchIcon.setIcon(new ImageIcon(imgPath + "search_24px.png"));
